...
export default function LoginTGSX() {
    const navigate = useNavigate();
    const { loginTGSX } = useAuth();  // 👈 version dành riêng TGSX
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            // Lưu session cho hệ thống TGSX
            loginTGSX({ token_tgsx: token, user_tgsx: user, role_tgsx: role }, remember);

            // Gắn token vào axios
            attachAuthToken(token);

            // Điều hướng vào hệ thống mới
            navigate("/tgsx/dinhmuc");
            ...
            >
                <Stack spacing={2}>
                    <Typography variant="h5" fontWeight={700} textAlign="center">
                        Đăng nhập hệ thống Tính thời gian SX
                    </Typography>
