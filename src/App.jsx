...
import HoaDonImportGroupDetailPage from "./pages/HoaDonImportGroupDetailPage";
  ...
  return (
    <Routes>
      ...
      <Route element={<RequireAuth />}>
        ...
        <Route path="/hoa-don-dien-tu/nhom-import/:id" element={<HoaDonImportGroupDetailPage />} />
