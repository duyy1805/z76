...
const STATUS_MAP = {
    ...
    ChoXuLy_HoaDon: { label: "Chờ phụ trách HĐ", color: "#027A48", background: "#ECFDF3" },
    ChoDuyet_KTT: { label: "Chờ KTT", color: "#175CD3", background: "#EFF4FF" },
    ChoDuyet_GD: { label: "Chờ GĐ", color: "#6941C6", background: "#F4F3FF" },
    SanSangXuat: { label: "Sẵn sàng xuất", color: "#175CD3", background: "#EFF4FF" },
    DaXuat: { label: "Đã xuất", color: "#087443", background: "#ECFDF3" },
